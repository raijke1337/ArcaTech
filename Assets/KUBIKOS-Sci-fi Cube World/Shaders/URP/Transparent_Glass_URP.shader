...
Shader "Animmal/Transparent_GlassURP"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEBegin]_Refraction("Refraction ", 2D) = "bump" {}
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 uv_Refraction = IN.ase_texcoord8.xy * _Refraction_ST.xy + _Refraction_ST.zw;
				float4 fetchOpaqueVal1 = float4( SHADERGRAPH_SAMPLE_SCENE_COLOR( ( ase_screenPosNorm + float4( ( UnpackNormalScale( tex2D( _Refraction, uv_Refraction ), 1.0f ) * _RefractionPower ) , 0.0 ) ).xy ), 1.0 );
				...
				float3 Albedo = ( fetchOpaqueVal1 * tex2D( _Albedo, uv_Albedo ) ).rgb;
				float3 Normal = float3(0, 0, 1);
				float3 Emission = ( tex2D( _Emission, uv_Emission ) * _EmissionPower ).rgb;
				float3 Specular = 0.5;
				float Metallic = 0;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 ase_screenPosNorm = screenPos / screenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float2 uv_Refraction = IN.ase_texcoord5.xy * _Refraction_ST.xy + _Refraction_ST.zw;
				float4 fetchOpaqueVal1 = float4( SHADERGRAPH_SAMPLE_SCENE_COLOR( ( ase_screenPosNorm + float4( ( UnpackNormalScale( tex2D( _Refraction, uv_Refraction ), 1.0f ) * _RefractionPower ) , 0.0 ) ).xy ), 1.0 );
				float2 uv_Albedo = IN.ase_texcoord5.xy * _Albedo_ST.xy + _Albedo_ST.zw;
				
				float2 uv_Emission = IN.ase_texcoord5.xy * _Emission_ST.xy + _Emission_ST.zw;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 ase_screenPosNorm = screenPos / screenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float2 uv_Refraction = IN.ase_texcoord3.xy * _Refraction_ST.xy + _Refraction_ST.zw;
				float4 fetchOpaqueVal1 = float4( SHADERGRAPH_SAMPLE_SCENE_COLOR( ( ase_screenPosNorm + float4( ( UnpackNormalScale( tex2D( _Refraction, uv_Refraction ), 1.0f ) * _RefractionPower ) , 0.0 ) ).xy ), 1.0 );
...
/*ASEBEGIN
Version=18935
556;503.3333;1217.333;875.6667;668.2482;315.5193;1.546846;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;9;-923.8688,479.8666;Inherit;False;Property;_RefractionPower;Refraction Power;1;0;Create;True;0;0;0;False;0;False;0;0.015;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;15;-302.4256,601.9293;Inherit;True;Property;_Emission;Emission;3;0;Create;True;0;0;0;False;0;False;-1;None;b6bf5325e7c19d24c8be07402bdc9a53;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;14;-437.2933,372.0413;Inherit;True;Property;_Albedo;Albedo;2;0;Create;True;0;0;0;False;0;False;-1;None;d21ce93fe0eead740aa687f3604c0e4a;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=91EC09F3126C3851DDE6C4A41D8AEFA25D10DB20