...
namespace Coffee.UIExtensions.Editors
{
    ...
    {
        [MenuItem("GameObject/UI (Canvas)/Unmask/Tutorial Button")]
...
#else
            const string menuItemName = "GameObject/UI (Canvas)/Button";
#endif
        ...
        [MenuItem("GameObject/UI (Canvas)/Unmask/Iris Shot")]
        ...
        [MenuItem("GameObject/UI (Canvas)/Unmask/Unmasked Panel")]
        ...
        {
            EditorApplication.ExecuteMenuItem("GameObject/UI (Canvas)/Panel");
